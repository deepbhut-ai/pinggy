...
| 0013 | 0013_email_system.py | DROP pwresets/email_logs + coupon col | email_logs, password_resets, payments.coupon_code | applied (local, v0.5.0) |
| 0012 | 0012_app_settings_and_coupons.py | DROP both tables | app_settings KV store + coupons table + idx | applied (local, v0.4.0) |
