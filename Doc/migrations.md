...
| 0033 | 0033_api_keys_security.py | 0033_api_keys_security.down.sql | api_keys: add is_active BOOLEAN, drop key_plain VARCHAR | applied (v2.8.5) |
...
| 0025 | 0025_api_keys_expiry.py | DROP col + idx | api_keys.expires_at (optional expiry) | applied (local, v1.6.0) |
