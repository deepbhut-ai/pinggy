...
export default function ApiDocs() {
  ...
  const sections = [
    ...
    {
      id: 'domains',
      title: '2. Domains — add root domains and subdomains',
      subtitle: 'First add a root domain, then create subdomains under it. Each root domain gets its own token automatically.',
      endpoints: [
        { method: 'GET',    path: '/domains',                 desc: 'Step 2a: List all your root domains and attached subdomains.' },
        { method: 'POST',   path: '/domains',                 desc: 'Step 2b: Add a root domain. This creates a dedicated token with that domain as the primary address.' },
        { method: 'PUT',    path: '/domains/{domain}',        desc: 'Step 2c: Rename a root domain to a new domain.' },
        { method: 'DELETE', path: '/domains/{domain}',        desc: 'Step 2d: Remove a root domain and its token.' },
        { method: 'GET',    path: '/subdomains',              desc: 'Step 2e: List all subdomains under your root domains.' },
        { method: 'POST',   path: '/subdomains',              desc: 'Step 2f: Create a subdomain under one of your root domains.' },
        { method: 'PUT',    path: '/subdomains/{subdomain}',  desc: 'Step 2g: Rename a subdomain.' },
        { method: 'DELETE', path: '/subdomains/{subdomain}',  desc: 'Step 2h: Remove a subdomain.' },
      ],
    },
    {
      id: 'tunnel',
    ...
    {
      id: 'advanced',
      title: '4. Advanced token domain options',
    ...
    {
      id: 'teams',
      title: '5. Teams — share tokens with your team',
      subtitle: 'Create a team, add members, and assign roles.',
      endpoints: [
        { method: 'GET',    path: '/teams',                   desc: 'Step 5a: List your teams and their members.' },
        { method: 'POST',   path: '/teams',                  desc: 'Step 5b: Create a new team.' },
        { method: 'POST',   path: '/teams/{team_id}/members', desc: 'Step 5c: Invite a member to a team.' },
        { method: 'PATCH',  path: '/teams/{team_id}/members/{email}', desc: 'Step 5d: Change a member role (admin or member).' },
        { method: 'DELETE', path: '/teams/{team_id}/members/{email}', desc: 'Step 5e: Remove a member from a team.' },
      ],
    },
    {
      id: 'billing',
      title: '6. Billing and support',
